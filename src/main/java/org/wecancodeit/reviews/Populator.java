...
public class Populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        TvShowReviews strangerThingsSeason2 = new TvShowReviews(horror, "Stranger Things season 2", "November", "two", "It's bs", "Three Stars", "/Images/Stranger_Things_season_2.jpg");

        TvShowReviews theOffice = new TvShowReviews(comedy, "the office", "march", "five", "it's alright", "one star", "/Images/The-Office.jpg");

        TvShowReviews pAndR = new TvShowReviews(comedy, "P&R", "march", "six", "it's okay", "two star", "/Images/P&R.jpg");
