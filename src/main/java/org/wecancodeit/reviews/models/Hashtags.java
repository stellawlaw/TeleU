...
public class Hashtags {
    ...
    @ManyToMany
    private Set<TvShowReviews> tvShowReviews;
    ...
    public Hashtags(String name, String imageUrl, TvShowReviews... tvShowReviews) {
        ...
        this.tvShowReviews = new HashSet<>(List.of(tvShowReviews));
    }
    ...
    public void addReview(TvShowReviews review) {
        tvShowReviews.add(review);
    }
}
